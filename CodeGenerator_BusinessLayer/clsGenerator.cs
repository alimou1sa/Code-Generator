...
namespace CodeGenerator_BusinessLayer
{
    public class clsGenerator
    {
        ...
        private static string _CreatFormatDataClas(string ProjrctName,bool IsDataAccess, string TableName)
        {

            string ClassType = null;
            string LibraryType = null;

            LibraryType = (IsDataAccess ? " " :  $"using {ProjrctName}__DataAccessLayer ;\n");
            ClassType = (IsDataAccess ? "_DataAccessLayer" : "_BusinessLayer");
    ...
    {    ";
        ...
        private static string _CreatFuncAddNewInfoToTableData(string TableName )
        {
            ...
            foreach (clsProperty Property in table.NormalProperties)
            {
                ...
                {
                    CreateSQLCommand.Append(";\n" + $@" if (" + Property.name + @" !="+clsDataType.GetNulleblData(Property.CSharpDataType) +" &&" + Property.name + $@" != null)
                                 command.Parameters.AddWithValue(@""{Property.name}"" , " + Property.name + $@"); 
                            else
            ...
            foreach (clsProperty Property in table.NormalProperties)
            {
                ...
                else
                {
                    Creatreader.Append("\n     " + $@" if (reader[""{Property.name}""] != DBNull.Value)" + @"
                        ...
                        {" + $@"
                          {Property.name} = "+clsDataType.GetNulleblData(Property.CSharpDataType) +";" + @"
                        }");
...
");
        ...
        private static string _CreatDataAccessSettingsClass(string ProjrctName)
        {
...
namespace "+$@"{ProjrctName}"+ "__DataAccessLayer" + @"
{
...
";
        ...
        private static string _CreatBusinessLayerClass(string ProjrctName,string  Tabl)
        {
            ...
            sb.Append(_CreatFormatDataClas(ProjrctName,false, Tabl ) + "\n\n");
        ...
        private static string _CreatDataAccessLayerClass(string ProjrctName,string Tabl)
        {
            ...
            sb.Append(_CreatFormatDataClas(ProjrctName, true, Tabl + "Data")+"\n\n");
            ...
            clsData.CreatFileCs(Path+"\\" + ProjrctName + "DataAccessLayer"
                + "\\clsDataAccessSetting.cs"
                   , _CreatDataAccessSettingsClass(ProjrctName));
